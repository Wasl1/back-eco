...
@Module({
  ...
  imports: [MongooseModule.forRoot('mongodb://localhost:27017/ecommerce', {useCreateIndex: true, useNewUrlParser: true, useUnifiedTopology: true }), UsersModule, AuthModule],
